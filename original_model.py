...
def GL_network(input_shape=(128, 88, 1), weight_decay=0.00005, num_classes=86):
...
def original_GL_network(input_shape=(128, 88, 1), weight_decay=0.00005, num_classes=86):
